...
import { WorkerPool } from '../js/WorkerPool.js';
import {
	read,
...
} from '../js/ktx-parse.module.js';
import { ZSTDDecoder } from '../js/zstddec.module.js';
	...
	detectSupport( renderer ) {
		...
		if ( renderer.isWebGPURenderer === true ) {
			...
			this.workerConfig = {
				...
				bptcSupported: renderer.extensions.get( 'EXT_texture_compression_bptc' ),
